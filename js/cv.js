...
function generarPDF(){
    ...
    var str1 = document.getElementById("cuadroImagen").innerHTML;
    var res = str1; 
...
{
document.getElementById("listaColaborador").innerHTML= document.getElementById("listaColaborador").innerHTML+document.getElementById("colaborador").value+"<br>"
}
...
if (confirm(id_div))
document.getElementById(id_div).value= resultado.results[0][0].transcript;
else
recognition.stop()
}
